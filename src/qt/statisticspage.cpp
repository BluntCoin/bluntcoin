...
void StatisticsPage::updateStatistics()
{
    ...
    else if (nHeight > 3142)
    {
        phase = "PoS";
    }

    QString subsidy = nHeight > 3142 ? "n/a" : FormatMoney(GetProofOfWorkReward(0)).c_str();
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " BLUNT" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " BLUNT" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " BLUNT");
    }
