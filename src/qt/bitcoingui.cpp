...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    notificator(0),
    rpcConsole(0),
    movie2(new QMovie(":/gif/bluntcoinr")),
    nWeight(0)
{
    resize(1150, 810);
    setWindowTitle(tr("BluntCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
//    darkPalette.setColor(QPalette::WindowText, QColor(242, 202, 128));
//    darkPalette.setColor(QPalette::Base, QColor(25, 24, 24));
//    darkPalette.setColor(QPalette::AlternateBase, QColor(28, 28, 28));
//    darkPalette.setColor(QPalette::ToolTipBase, Qt::black);
//    darkPalette.setColor(QPalette::ToolTipText, QColor(242, 202, 128));
//    darkPalette.setColor(QPalette::Text, QColor(242, 202, 128));
//    darkPalette.setColor(QPalette::Button, QColor(35, 34, 33));
//    darkPalette.setColor(QPalette::ButtonText, QColor(242, 202, 128));
//    darkPalette.setColor(QPalette::BrightText, QColor(255, 137, 0));
//    darkPalette.setColor(QPalette::Link, QColor(255, 137, 0));

//    darkPalette.setColor(QPalette::Highlight, QColor(242, 202, 128));
//    darkPalette.setColor(QPalette::HighlightedText, Qt::black);

//    qApp->setPalette(darkPalette);
    qApp->setStyleSheet("QToolTip { color: #00FF00; background-color: #006600; border: 1px solid #00FF00; }");
    ...
    mcalc = new MiningCalculator(this);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BluntCoin address"));
    ...
    messageAction = new QAction(QIcon(":/icons/smsg"), tr("&Messages"), this);
    messageAction->setToolTip(tr("View and Send Encrypted messages"));
    messageAction->setCheckable(true);
    messageAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_7));
    tabGroup->addAction(messageAction);

    consolePageAction = new QAction(QIcon(":/icons/console"), tr("&Console"), this);
    consolePageAction->setToolTip(tr("Command line RPC interface"));
    consolePageAction->setCheckable(true);
    consolePageAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_8));
    tabGroup->addAction(consolePageAction);

    profitExplorerPageAction = new QAction(QIcon(":/icons/profit"), tr("&BluntCoining Exploder"), this);
    profitExplorerPageAction->setToolTip(tr("Staking explorer"));
    profitExplorerPageAction->setCheckable(true);
    profitExplorerPageAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_9));
    tabGroup->addAction(profitExplorerPageAction);

    mcalcAction = new QAction(QIcon(":/icons/profit"), tr("&Mining Calculator"), this);
    mcalcAction->setToolTip(tr("Mining Calculator"));
    mcalcAction->setCheckable(true);
    tabGroup->addAction(mcalcAction);
    ...
    connect(mcalcAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(mcalcAction, SIGNAL(triggered()), this, SLOT(gotoMCalcPage()));

    quitAction = new QAction(QIcon(":/icons/quit"), tr("E&xit"), this);
    quitAction->setToolTip(tr("Quit application"));
    quitAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_Q));
    quitAction->setMenuRole(QAction::QuitRole);
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About The BluntCoin"), this);
    aboutAction->setToolTip(tr("Show information about The BluntCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for The BluntCoin"));
...
//    mainIcon->setContentsMargins(-40,20,10,10);
    mainIcon->setMovie(movie2);
    movie2->start();
    mainIcon->show();
    ...
    mainToolbar->addAction(mcalcAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BluntCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BluntCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BluntCoin network", "", count));
}
...
void BitcoinGUI::gotoMCalcPage()
{
    mcalcAction->setChecked(true);
    centralWidget->setCurrentWidget(mcalc);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BluntCoin address or malformed URI parameters."));
    }
