...
void ConsolePage::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BluntCoin RPC console.") + "<br>" +
...
void ConsolePage::dumpmarkethistory()
{
    ...
    QUrl url("https://api.empoex.com/markethistory/BLUNT-BTC");
...
{
    // get market history from empo ex api
    QUrl url("https://api.empoex.com/marketinfo/BLUNT-BTC");
    QNetworkRequest request;
    request.setUrl(url);
    qDebug() << "dumpmarkethistory()";
    QNetworkReply* currentReply = networkManager.get(request);
...
//[{"pairname":"BLUNT-BTC","last":"0.00002400","base_volume_24hr":"0.60486204","low":"0.00000989","high":"0.00002750","bid":"0.00001990",
...
//"open_buy_volume_base":"0.25689740","open_sell_volume_base":"0.16165537","change":"+9.14%"}]
    QString tbl = "<b>EmpoEx BLUNT-BTC</b><br><br><table cellpadding=\"5\" width=\"100%\"><thead><tr><th></th><th>Last</th><th>% Change</th><th>24hr Volume</th><th>Low</th><th>High</th><th>Bid</th><th>Ask</th></tr></thead>";
    tbl = tbl + "<tbody>";
    while (it.hasNext()) {
        it.next();
