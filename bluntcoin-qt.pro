...
macx {
    QMAKE_TARGET_BUNDLE_PREFIX = ninja.bluntcoin
    DEFINES += IS_ARCH_64
    QMAKE_CXXFLAGS += -arch x86_64 -stdlib=libc++ -mmacosx-version-min=10.9
    QMAKE_CFLAGS += -arch x86_64 -mmacosx-version-min=10.9
    QMAKE_LFLAGS += -arch x86_64 -stdlib=libc++ -mmacosx-version-min=10.9
}
...
FORMS += \
    ...
    src/qt/forms/miningcalculator.ui
...
macx:ICON = src/qt/res/icons/bluntcoin.icns
macx:TARGET = "BluntCoin-Qt"
